...
export default class TokenCancelAirdropTransaction extends AirdropPendingTransaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenCancelAirdropTransaction;
    /**
     * @override
     * @internal
     * @returns {HashgraphProto.proto.ITokenCancelAirdropTransactionBody}
     */
    override _makeTransactionData(): HashgraphProto.proto.ITokenCancelAirdropTransactionBody;
}
